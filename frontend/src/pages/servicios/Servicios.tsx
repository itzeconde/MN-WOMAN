...
export default function Servicios() {
  ...
  useEffect(() => {
    getCategoriasServicios().then(setCategorias).catch(console.error)
  }, [])
  ...
  // Color genérico por índice para categorías dinámicas
  const PALETA = [
          ...
          <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap', marginBottom: '28px' }}>
            ...
            {categorias.map((cat) => (
              <button
                ...
                style={{
                  padding: '7px 16px', borderRadius: '20px', border: '1px solid',
                  borderColor: categoriaActiva === cat ? '#B66878' : '#e5e7eb',
                  background: categoriaActiva === cat ? '#fdf2f4' : 'white',
                  color: categoriaActiva === cat ? '#B66878' : '#6b7280',
                  cursor: 'pointer', fontSize: '13px', fontWeight: '500',
