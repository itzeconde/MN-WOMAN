    ...
    <main style={{ fontFamily: "'Inter', 'Helvetica Neue', sans-serif" }}>
      ...
      <section className="hero-section" style={{
        ...
        <div style={{ maxWidth: '680px', position: 'relative', zIndex: 1 }}>
          ...
          <p style={{ fontSize: '19px', color: '#6b5b61', lineHeight: '1.75', margin: '0 0 44px', maxWidth: '540px' }}>
        ...
        <div style={{ maxWidth: '1120px', margin: '0 auto' }}>
          ...
          <div className="grid-4">
            {[
              ...
              <div key={pilar.title} className="card-hover" style={{
                ...
                <p style={{ fontSize: '16px', color: '#7a6870', lineHeight: '1.65', margin: 0 }}>
                  {pilar.desc}
                </p>
              </div>
            ))}
      ...
      {/* ── PRÓXIMOS EVENTOS ── */}
      {eventos.length > 0 && (
        <section className="section-pad" style={{ backgroundColor: '#fdfafb' }}>
          <div style={{ maxWidth: '1120px', margin: '0 auto' }}>
        ...
        <div style={{ maxWidth: '1120px', margin: '0 auto', textAlign: 'center' }}>
          ...
          <div className="colabs">
            {['Revista Momento', 'Las Hijas de la Malinche', 'Festival Tlaxqui', 'Networking'].map(colab => (
              <span key={colab} style={{ fontSize: '17px', fontWeight: '600', color: '#d4c8cc', letterSpacing: '0.04em' }}>
                {colab}
              </span>
            ))}
          </div>
      ...
      <section className="cta-section" style={{ background: '#f5e8eb', borderTop: '1px solid #edd8de' }}>
        <span style={{ display: 'inline-block', fontSize: '13px', fontWeight: '600', letterSpacing: '0.12em', textTransform: 'uppercase', color: '#B66878', marginBottom: '20px', opacity: 0.8 }}>
          Únete hoy
        </span>
